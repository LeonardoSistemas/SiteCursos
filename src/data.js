...
const data = {
  menus: [
    { text: 'Painel de bordo', icon: <Assessment/>, link: '/dashboard' },
    { text: 'Cadastrar', icon: <Web/>, link: '/form' },
    { text: 'Cursos', icon: <GridOn/>, link: '/table' },
    //{ text: 'Table Page', icon: <GridOn/>, link: '/table' },
    { text: 'Entrar', icon: <PermIdentity/>, link: '/login' }
  ],
  tablePage: {
    items: [
